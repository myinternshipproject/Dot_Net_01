<%@ Page Language="C#" AutoEventWireup="true" CodeFile="entertainment.aspx.cs" Inherits="entertainment" %>
...
<body>
	<div id="container">
        ...
        <div id="header2"> <form id="Form1" runat="server"> <asp:DropDownList ID="DropDownList1" Font-Names="suto" runat="server"></asp:DropDownList></form>  </div>
