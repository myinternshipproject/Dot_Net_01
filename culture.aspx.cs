...
public partial class culture : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
           ...
           // brief.news_show(tbl_info,4,lb_message);
            menu.main_menu(tbl_top_menu,4);
            menu.sub_menu(tbl_sub_menu, 4, 1, lb_message);
   ...
   {
         Session["PubNumber"] = DropDownList1.SelectedItem.Text;
        Session["PubId"] = DropDownList1.SelectedValue;
   }
